#!/usr/bin/env bash
set -uo pipefail
ROOT=/home/nebula/xxy/duograph3d_artifacts/onlineanyseg_official_subset20_sparse_20260423
...
SCENES=(scene0568_00 scene0568_01 scene0568_02 scene0304_00 scene0488_00 scene0488_01 scene0412_00 scene0412_01 scene0217_00 scene0019_00 scene0019_01 scene0414_00 scene0575_00 scene0575_01 scene0575_02 scene0426_00 scene0426_01 scene0426_02 scene0426_03 scene0549_00)
...
for scene in "${SCENES[@]}"; do
  ...
  /home/nebula/miniconda3/bin/conda run -n duograph-oas-cu116 python main.py \
    -c "$ROOT/scannet_subset20_sparse_clip512.yaml" \
    -d "$ROOT/input/$scene" \
