...
def main() -> None:
    ...
    for scene in args.scenes:
        ...
        export_summary = {}
        duograph_object_monitor = {"available": False}
    ...
    for item in scene_summaries:
        lines.append(
            ...
            f"{item['conceptgraphs_baseline_object_monitor'].get('semantic_accuracy', 0):.3f} | "
            f"{item['conceptgraphs_baseline_object_monitor'].get('semantic_cell_duplicates', {}).get('duplicate_rate', 0):.3f} |"
        )
