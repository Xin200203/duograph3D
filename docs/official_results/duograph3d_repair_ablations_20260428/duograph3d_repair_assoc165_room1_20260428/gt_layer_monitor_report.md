...
- Layer1 eval hypotheses: 4393
- Layer2 decision accuracy: 0.94514
- Layer2 duplicate birth rate: 0.789474
- Layer2 duplicate birth failure families: {'semantic_gate_low': 15}
- Layer2 residual absorption: 0 (accuracy 0.0)
- Layer2 ID switch events: 459
- DuoGraph3D object monitor: {'available_scene_count': 1, 'object_count': 14, 'valid_eval_object_count': 5, 'semantic_accuracy_weighted': 0.6, 'semantic_cell_duplicate_count': 0, 'semantic_cell_duplicate_rate_micro': 0.0}
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| room1 | 0.222 | 0.200 | 0.019 | 0.945 | 0.789 | 0.106 | 14 | 0.600 | 0.000 | 67 | 0.432 | 0.189 |
